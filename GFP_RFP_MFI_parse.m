...
clear
directory = '/Users/Christina/Documents/Ph.D 2015-2019/Lab Data/Microscopy/PA14 WT vs ladS01 vs PA01 Lineage Analysis/11.28.18 PA14 ladS01 MinS_NTA/Colony 8/';




%this script does the same thing as MFI_calc_fit, but saves separate dat
...
rfpimgfilestr=['RFP-' matfilenames{fnum}(1:end-4) '.tif'];
...
outfilename=matfilename(1:end-4);
gfpoutfilename=[outfilename '/gfpmfi' imgfilestr num2str(tframes(t)) '.dat'];
save(gfpoutfilename,'gfpmfi','-ascii')


rfpoutfilename=[outfilename '/rfpmfi' rfpimgfilestr num2str(tframes(t)) '.dat'];
